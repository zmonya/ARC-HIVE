...
try {
    ...
    if ($specificFileId) {
        ...
        // First verify the file exists and get its current file_type
        $stmt = $pdo->prepare("SELECT file_id, file_name, file_path, file_type, file_status FROM files WHERE file_id = ?");
